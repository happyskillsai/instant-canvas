...
$('stopBtn').addEventListener('click', async () => {
	...
	document.body.innerHTML = '<div class="empty full"><div class="big"></div><b>Kernel stopped</b><div>Run <code>npx instant-canvas open</code> again to restart it.</div></div>'
})
